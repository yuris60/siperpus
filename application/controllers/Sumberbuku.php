...
class sumberbuku extends CI_Controller
{
  ...
  {
    parent::__construct();
    $this->load->model('sumberbuku_model');
  ...
  public function index()
  {
    ...
    $this->load->view('sumberbuku/sumberbuku_index', $data);
  ...
  public function create()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('sumberbuku/sumberbuku_create', $data);
      $this->load->view('templates/footer');
      $this->load->view('templates/js');
    } else {
  ...
  public function update($where)
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('sumberbuku/sumberbuku_update', $data);
      $this->load->view('templates/footer');
      $this->load->view('templates/js');
    } else {
  ...
  public function scan()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('sumberbuku/sumberbuku_scan', $data);
    $this->load->view('templates/footer');
