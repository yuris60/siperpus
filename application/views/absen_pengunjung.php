  ...
  <div class="page-content">
    <div class="row">
      <div class="col-lg-4">
        <div class="card">
          <div class="card-header">
            <h4><img src="<?= base_url('assets/svg/qr-code.svg') ?>" alt="" style="margin-top: -5px;"> Scan QR Code Disini</h4>
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-header">
            <h4><img src="<?= base_url('assets/svg/qr-code.svg') ?>" alt="" style="margin-top: -5px;"> Hasil Scan Barcode</h4>
          </div>
          <div class="card-body">
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-user"></i> Data Pengunjung Hari Ini</h4>
          </div>
          <div class="card-body">
