...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/img/Logo SIPERPUS favicon.png') ?>" rel="icon">
  ...
  <!-- Owl Carousel -->
  <link rel="stylesheet" href="<?= base_url('assets/vendor/owl-carousel/dist/') ?>assets/owl.carousel.css">
