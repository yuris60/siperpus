  ...
  <form action="" method="POST" autocomplete="off">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <input type="hidden" name="id_kategoribuku" value="<?= $kategoribuku['id_kategoribuku']; ?>">

        <div class="form-group">
          <label>Nama Jenis Buku</label>
          <input type="text" class="form-control <?= form_error('nm_kategoribuku') ? 'is-invalid' : '' ?>" name="nm_kategoribuku" id="nm_kategoribuku" value="<?= $kategoribuku['nm_kategoribuku']; ?>">
