...
<div class="row">
  <div class="col-12 col-xl-9 col-md-12 col-xs-12">
    <div class="card">
  ...
  <div class="col-12 col-xl-3 col-md-12 col-xs-12">
    <!-- <div class="card">
      <div class="card-header">
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link btn-sm active" id="pills-hariini-tab" data-bs-toggle="pill" data-bs-target="#pills-hariini" type="button" role="tab" aria-controls="pills-hariini" aria-selected="true">Hari Ini</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link btn-sm" id="pills-keseluruhan-tab" data-bs-toggle="pill" data-bs-target="#pills-keseluruhan" type="button" role="tab" aria-controls="pills-keseluruhan" aria-selected="false">Keseluruhan</button>
              </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
