  ...
  <div class="card">
    <div class="card-header">
      <h4 class="card-title"><i class="fas fa-database"></i> Data
        <a href="<?= base_url('admin/klasifikasiddc/create') ?>" class="float-end"><button class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah Data"><i class="fas fa-plus"></i></button></a>
      </h4>
    </div>
    <div class="card-body">
        ...
        <tbody>
          ...
          foreach ($klasifikasiddc as $kd) : ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('admin/klasifikasiddc/update/') . $kd['id_ddc']; ?>">
                ...
                <a href="<?= base_url('admin/klasifikasiddc/delete/') . $kd['id_ddc']; ?>" class="tombol-hapus">
