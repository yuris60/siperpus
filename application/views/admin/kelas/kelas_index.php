  ...
  <div class="card">
    <div class="card-header">
      <h4 class="card-title"><i class="fas fa-database"></i> Data
        <a href="<?= base_url('admin/kelas/create') ?>" class="float-end"><button class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Tambah Data"><i class="fas fa-plus"></i></button></a>
      </h4>
    </div>
    <div class="card-body">
          ...
          foreach ($kelas as $k) : ?>
            <tr>
              ...
              <td>
                ...
                echo $tingkatan_kelas . " " . $k['nm_jurusan'] . " " . $k['nomor_kelas']
                ?>
              </td>
              <td>
                <a href="<?= base_url('admin/kelas/delete/') . $k['id_kelas']; ?>" class="tombol-hapus">
