<div class="content-wrapper container">
  ...
  <div class="page-heading">
    <h3>Selamat Datang di e-Library SMK Soedirman Purbalingga</h3>
  </div>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  <img src="<?= base_url('assets/img/carousel/2.jpg') ?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="<?= base_url('assets/img/carousel/3.jpg') ?>" class="d-block w-100" alt="...">
                </div>
              </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex align-items-center">
                      <svg class="bi text-primary" width="32" height="32" fill="blue" style="width:10px">
                        <use xlink:href="<?= base_url('assets/vendor/mazer/dist/') ?>assets/vendors/bootstrap-icons/bootstrap-icons.svg#circle-fill" />
                      </svg>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="col-3">
                          <div class="d-flex align-items-center">
                            <div class="avatar avatar-md">
                              <img src="<?= base_url('assets/vendor/mazer/dist/') ?>assets/images/faces/2.jpg">
                            </div>
